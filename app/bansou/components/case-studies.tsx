...
const caseStudies = [
  {
    ...
    description: '週１回の２時間の打ち合わせを重ねサービスリリースに伴走いただきました。現在も伴走してもらいながら、先日ベータ版リリースを行い、１０社の契約を獲得できました。',
  ...
  {
    title: '社員教育（先輩として伴走）',
    description: 'Wordpressによるサイト制作には慣れているが、システム開発も自社で開発できるようにしたいと思い相談しました。自社には教えられるエンジニアがおらず、頼れる先輩エンジニアとして育てていただきました。',
    client: 'Web制作企業（九州）',
    tasks: [
      '従業員へのプログラミング教育',
      '要件定義の実施方法レクチャー',
